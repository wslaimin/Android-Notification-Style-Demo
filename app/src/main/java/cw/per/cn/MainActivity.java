...
public class MainActivity extends Activity {
    ...
    @OnClick(R.id.simple_notification_sound_vibrate)
    public void dispalySimpleNotification1(){
        notificationCreator.createSimpleNotification1(this);
    }

    @OnClick(R.id.simple_notification_regular_back)
    public void dispalySimpleNotification2(){
        notificationCreator.createSimpleNotification2(this);
    }

    @OnClick(R.id.simple_notification_special_back)
    public void dispalySimpleNotification3(){
        notificationCreator.createSimpleNotification3(this);
    }
