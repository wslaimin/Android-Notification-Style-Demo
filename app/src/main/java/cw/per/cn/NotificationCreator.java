...
public class NotificationCreator {
    ...
    public  void createSimpleNotification1(Context context){
        //为了版本兼容  选择V7包下的NotificationCompat进行构造
        android.support.v4.app.NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setTicker("简单Notification")      //Ticker是状态栏显示的提示
                .setContentTitle("标题")            //第一行内容  通常作为通知栏标题
    ...
    public  void createSimpleNotification2(Context context){
        //为了版本兼容  选择V7包下的NotificationCompat进行构造
        android.support.v4.app.NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setTicker("简单Notification")      //Ticker是状态栏显示的提示
                .setContentTitle("标题")            //第一行内容  通常作为通知栏标题
    ...
    public  void createSimpleNotification3(Context context){
        //为了版本兼容  选择V7包下的NotificationCompat进行构造
        android.support.v4.app.NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setTicker("简单Notification")      //Ticker是状态栏显示的提示
                .setContentTitle("标题")            //第一行内容  通常作为通知栏标题
                ...
                .setSmallIcon(R.drawable.ic_app)//系统状态栏显示的小图标
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(),R.drawable.ic_app_large)); //下拉显示的大图标
        Intent intent = new Intent(context,SecondTestActivity.class);
    ...
    public void createBigTextNotification(Context context){
        ...
        style.setBigContentTitle("点击后的标题"); //会覆盖setContentTitle()的值
